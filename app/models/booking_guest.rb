class BookingGuest
  ...
  attr_accessor :user_id, :event_id, :last_name, :first_name, :phone_number, :email, :checkin, :checkout, :message, :adult,
                :child, :infant, :token
  ...
  def save
    ...
    # ゲストの情報を保存する
    Guest.create(last_name: last_name, first_name: first_name, phone_number: phone_number, email: email, checkin: checkin,
                 checkout: checkout, message: message, adult: adult, child: child, infant: infant, booking_id: booking.id)
  end
end
